...
var LoadImg="<img src=http://brainoil.narod.ru/img/arrow/loading.gif width=16 height=16 border=0>";
...
script.type="text/javascript";
script.src="http://brainoil.narod.ru/"+xfile+"?xdac="+Math.random();
...
as_audio=""
+"<audio autoplay>"
+"<source src=\"http://brainoil.narod.ru/audio/achtung.mp3\" type=\"audio/mpeg\">"
+"</audio>";
document.getElementById("rjob").innerHTML=""
