...
var LoadImg="<img src=https://7700300.github.io/narod.github.io/img/arrow/loading.gif width=16 height=16 border=0>";
...
script.type="text/javascript";
script.src="https://7700300.github.io/narod.github.io/"+xfile+"?xdac="+Math.random();
...
as_audio=""
+"<audio autoplay>"
+"<source src=\"https://7700300.github.io/narod.github.io/audio/achtung.mp3\" type=\"audio/mpeg\">"
+"</audio>";
document.getElementById("rjob").innerHTML=""
...
if(ME.id==202436630 || ME.id==200411306) { //block-style
...
if(ME.id==100214920 || ME.id==202436630 || ME.id==200411306 || ME.id==201135707) { // bb sv59190 Primere hetzer
...
mbPereman=812596;
mbCurse=824404;
abilityFireDust=2123385;
abilityKill=2368493;
abilityAbort=1596757;
